...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        { charset: 'utf-8' },
        { name: 'google-site-verification', content: 'fc0leVH2rEEg11WzYf4oiWOD1nxJ4PKw4jREetPzmO0' },
      ...
      link: [
        { rel: 'icon', type: 'image/x-icon', href: '/favicon.ico?v=202509' },
        { rel: 'apple-touch-icon', sizes: '180x180', href: '/apple-touch-icon.png?v=202509' },
        { rel: 'icon', type: 'image/png', sizes: '32x32', href: '/favicon-32x32.png?v=202509' },
        { rel: 'icon', type: 'image/png', sizes: '16x16', href: '/favicon-16x16.png?v=202509' },
        { rel: 'manifest', href: '/site.webmanifest?v=202509' },
